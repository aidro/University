...
class Parser:
    def Parse(self):
        ...
        parser.add_argument('-ct_disk_size', metavar='net_bridge', type=int)
        parser.add_argument('-ct_nic_rate_limit', metavar='net_bridge', type=int)
        parser.add_argument('-ct_memory', metavar='net_bridge', type=int)
        parser.add_argument('-ct_source_file_path', metavar='net_bridge', type=int)
        parser.add_argument('-dns_domain', metavar='net_bridge', type=int)
        parser.add_argument('-dns_server', metavar='net_bridge', type=int)
        parser.add_argument('-gateway', metavar='net_bridge', type=int)
        parser.add_argument('-os_type', metavar='net_bridge', type=int)
        parser.add_argument('-tmp_dir', metavar='net_bridge', type=int)
        # Parse the arguments
